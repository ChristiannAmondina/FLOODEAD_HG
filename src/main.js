...
import { 
    ...
    created_nearstatue ,created_fallingceiling
  } from './js/objects.js';
...
loader.load('/images/models/zombie_monster_slasher_necromorph.glb', (gltf) => {
  zombie = gltf.scene;
  zombie.scale.set(5.5, 5.5, 5.5);
  zombie.position.set(-70, 0, 70); // Starting position of the zombie
